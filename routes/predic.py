...
predic_bp.route('/view_processed_files')(predic_controller.view_processed_files_controller)
predic_bp.route('/dashboard4')(predic_controller.dashboard4_controller)