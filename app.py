...
from routes.laboratorio import laboratorio_bp

app = Flask(__name__)

# --- Base directory (ruta absoluta del proyecto) ---
...
def dashboard():
    """
    Renderiza el Dashboard General de análisis de métricas y precisión del modelo.
    No interfiere con los blueprints ni otras rutas.
    """
