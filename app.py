...
from routes.reposicion_routes import reposicion_bp
from routes.test_compra_routes import test_compra_bp

app = Flask(__name__)

# --- Configurations ---
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:root@127.0.0.1/predic'
...
app.register_blueprint(test_compra_bp)
...
@app.route('/test_compra')
def test_compra():
    """Render the test_compra page."""
